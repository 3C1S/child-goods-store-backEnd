...
public class MailService {
    ...
    public String joinEmail(String email) {
        makeRandomNumber();
        String setFrom = "ariel020918@naver.com"; //email-config에 설정한 이메일 주소를 입력
        String toMail = email;
        ...
        return "authNumber: " + Integer.toString(authNumber);
    }
    ...
    public void mailSend(String setFrom, String toMail, String title, String content) {
        ...
        try {
            ...
            helper.setText(content,true); //이메일의 내용 설정. 두 번째 매개 변수에 true를 설정하여 html 설정으로 함.
